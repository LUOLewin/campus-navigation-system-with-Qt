...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_place_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_place_t qt_meta_stringdata_place = {
    {
QT_MOC_LITERAL(0, 5) // "place"
...
const QMetaObject place::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_place.offsetsAndSize,
    qt_meta_data_place,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_place_t
, QtPrivate::TypeAndForceComplete<place, std::true_type>
